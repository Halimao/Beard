...
import {Beard} from "../src/Beard.sol";

contract BeardTest is Test {
    // Variables
    Beard public token;
    ...
    function test_totalSupply() public {
        assertEq(token.totalSupply(), 1_000_000_000 * 1 ether);
    }
    ...
    function test_balanceOfAddressSupplyOwner() public {
        assertEq(token.balanceOf(supplyOwnerAddress), 1_000_000_000 * 1 ether);
    }
    ...
    function test_transfer() public {
        ...
        assertEq(token.balanceOf(supplyOwnerAddress), 1_000_000_000 * 1 ether - 100);
    }
    ...
    function test_transferFrom() public {
        ...
        assertEq(token.balanceOf(supplyOwnerAddress), 1_000_000_000 * 1 ether - 10);
